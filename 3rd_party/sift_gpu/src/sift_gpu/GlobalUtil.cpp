...
// NOTE: modified by jheinly
#define TIMING_BY_CLOCK
...
{
#ifdef WIN32
	strcpy_s(_current_event, 256, event); // Size of destination buffer is 256 bytes as specified in GlobalUtil.h
#else
