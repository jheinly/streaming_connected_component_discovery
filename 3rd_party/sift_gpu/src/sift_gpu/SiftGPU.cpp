...
const float * SiftGPU::GetKeypointVector() const
{
  return _pyramid->GetKeypointVector();
}

// NOTE: modified by jheinly
const float * SiftGPU::GetDescriptorVector() const
{
  return _pyramid->GetDescriptorVector();
}
